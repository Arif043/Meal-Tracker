...
final TextStyle darkThemeHeadingTextStyle =
lightHeadingText.copyWith(color: darkTextColorPrimary);

final TextStyle darkThemeBodyeTextStyle =
lightBodyText.copyWith(color: darkTextColorPrimary);
...
final FloatingActionButtonThemeData lightFloatingTheme = FloatingActionButtonThemeData(backgroundColor: appbarColorLight, foregroundColor: containerColorLight);
...
final ThemeData lightTheme = ThemeData(
  tabBarTheme: TabBarTheme(dividerColor: Colors.red, indicatorColor: Colors.orange, labelStyle: lightBodyText, unselectedLabelStyle: TextStyle(color: Colors.red),),
